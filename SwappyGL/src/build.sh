...
then
    export ANDROID_NDK_HOME="/Users/$USER/Documents/Android/sdk/ndk/23.1.7779620"
fi
...
for i in "${AndroidArchitectures[@]}"
    do
        ...
        {
            find sourceFiles -name "*.so" -exec cp {} ../../libs/$ABI_Folder_Name \;
        } &> /dev/null
